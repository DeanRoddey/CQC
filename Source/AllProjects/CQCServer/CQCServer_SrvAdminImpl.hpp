//
// FILE NAME: CQCServer_SrvAdminImpl.hpp
//
// AUTHOR: Dean Roddey
//
// CREATED: 03/29/2001
...
// DESCRIPTION:
//
//  This is the header for the TCQCSrvAdminImpl class, which implements the
//  IDL interface provided by CQCKit for CQCServer remote admin.
//
// CAVEATS/GOTCHAS:
//
// LOG:
...
//  PREFIX: orbs
// ---------------------------------------------------------------------------
class TCQCSrvAdminImpl : public TCQCSrvAdminServerBase
{
    public :
        // --------------------------------------------------------------------
        // Constructors and Destructor
        // --------------------------------------------------------------------
        TCQCSrvAdminImpl() = default;

        TCQCSrvAdminImpl(const TCQCSrvAdminImpl&) = delete;
        TCQCSrvAdminImpl(TCQCSrvAdminImpl&&) = delete;
        ...
        //  Public operators
        // --------------------------------------------------------------------
        TCQCSrvAdminImpl& operator=(const TCQCSrvAdminImpl&) = delete;
        TCQCSrvAdminImpl& operator=(TCQCSrvAdminImpl&&) = delete;
    ...
    private :
        ...
        //  Magic macros
        // --------------------------------------------------------------------
        RTTIDefs(TCQCSrvAdminImpl,TCQCSrvAdminServerBase)
};
