...
//  streams to Barix ExStreamer devices.
//
// CAVEATS/GOTCHAS:
//
// LOG:
...
namespace BarixAudPlS
{
    ...
    // -----------------------------------------------------------------------
    TFacility* pfacBarixAudPlS = nullptr;
}
...
TFacility& facBarixAudPlS()
{
    ...
    //  it exists.
    //
    return *BarixAudPlS::pfacBarixAudPlS;
}
...
psdrvMakeNewSrv(const TCQCDriverObjCfg& cqcdcToLoad)
{
    ...
    //  in.
    //
    BarixAudPlS::pfacBarixAudPlS = new TFacility
    (
        kBarixAudPlS::pszServerFacName
        , tCIDLib::EModTypes::SharedLib
        , kBarixAudPlS::c4MajVersion
        , kBarixAudPlS::c4MinVersion
        , kBarixAudPlS::c4Revision
        , tCIDLib::EModFlags::HasMsgFile
    );

    // And now gen up an instance of our driver and return it
    return new TBarixAudPlSDriver(cqcdcToLoad);
}
