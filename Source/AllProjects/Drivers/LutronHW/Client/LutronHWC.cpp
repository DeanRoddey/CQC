...
namespace LutronHWC
{
    ...
    // -----------------------------------------------------------------------
    TGUIFacility* pfacLutronHWC = nullptr;


    // -----------------------------------------------------------------------
    //  The base name of our facility
    // -----------------------------------------------------------------------
    const tCIDLib::TCh* const   pszClientFacName = L"LutronHWC";
}
...
TGUIFacility& facLutronHWC()
{
    ...
    //  it exists.
    //
    return *LutronHWC::pfacLutronHWC;
}
                ...
                , const TCQCUserCtx&        cuctxToUse)
{
    ...
    (
        tCIDLib::ECSSides::Client, cqcdcToLoad, LutronHWC::pszClientFacName
    );
    ...
    //  in.
    //
    LutronHWC::pfacLutronHWC = new TGUIFacility
    (
        LutronHWC::pszClientFacName
    ...
    //  client side.
    //
    TLutronHWCWnd* pwndClient = new TLutronHWCWnd(cqcdcToLoad, cuctxToUse);
