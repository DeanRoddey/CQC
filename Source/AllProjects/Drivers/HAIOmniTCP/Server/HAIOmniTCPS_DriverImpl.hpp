//
// FILE NAME: HAIOmniTCPS_DriverImpl.hpp
//
// AUTHOR: Dean Roddey
//
// CREATED: 05/16/2008
...
//  PREFIX: sdrv
// ---------------------------------------------------------------------------
class THAIOmniTCPSDriver : public TCQCServerBase
{
    public :
        // -------------------------------------------------------------------
    ...
    private :
        ...
        // -------------------------------------------------------------------
        THAIOmniTCPSDriver();
        THAIOmniTCPSDriver(const THAIOmniTCPSDriver&);
        tCIDLib::TVoid operator=(const THAIOmniTCPSDriver&);
        ...
        //
        //  m_c4CntXXX
        //      When we get config and have to register fields, we count up
        //      the actual number of each type of the item oriented things we
        //      keep track of. These can't change unless the config changes
        //      in which case we would re-register fields.
        //
        //  m_c4MaxXXX
        ...
        //
        //  m_splBuffers
        //      Because of the fact that we have to both deal with async messages
        //      and sometimes ask the device for info while we are dealing with other
        //      replies and so forth, we cannot just have a fixed set of buffers. So
        //      we create a pool and they are gotten out as required.
        //
        //  m_strCfgFile
        ...
        tCIDLib::TCard4         m_ac4FldId_EnclBattery[kHAIOmniTCPSh::c4MaxEnclosures];
        tCIDLib::TCard4         m_ac4FldId_EnclACOff[kHAIOmniTCPSh::c4MaxEnclosures];
        tCIDLib::TCard4         m_ac4FldId_EnclBattLow[kHAIOmniTCPSh::c4MaxEnclosures];
        tCIDLib::TCard4         m_ac4FldId_EnclCommFail[kHAIOmniTCPSh::c4MaxEnclosures];
        ...
        //  Magic macros
        // -------------------------------------------------------------------
        RTTIDefs(THAIOmniTCPSDriver,TCQCServerBase)
};
