...
// DESCRIPTION:
//
//  This is the main implementation file for the MQTT driver.
//
// CAVEATS/GOTCHAS:
//
// LOG:
...
psdrvMakeNewSrv(const  TCQCDriverObjCfg& cqcdcToLoad)
{
    ...
    (
        tCIDLib::ECSSides::Server, cqcdcToLoad, kMQTTS::pszServerFacName
    );
    ...
    //  in.
    //
    MQTTS::pfacMQTTS = new TFacility
    (
        kMQTTS::pszServerFacName
