...
TTextOutStream& operator<<(TTextOutStream& strmTar, const tMQTTSh::EClStates eVal)
{
...
TTextOutStream& operator<<(TTextOutStream& strmTar, const tMQTTSh::EMsgSrcs eVal)
{
...
TTextOutStream& operator<<(TTextOutStream& strmTar, const tMQTTSh::EPLTypes eVal)
{
