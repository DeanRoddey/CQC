...
namespace tMQTTSh
{
    ...
    MQTTSHEXPORT tCIDLib::TBoolean bIsValidEnum(const EClStates eVal);
    ...
    MQTTSHEXPORT EMapDirs eXlatEMapDirs(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    MQTTSHEXPORT const TString& strXlatEMapDirs(const EMapDirs eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    MQTTSHEXPORT tCIDLib::TBoolean bIsValidEnum(const EMapDirs eVal);
    ...
    MQTTSHEXPORT EInMapRes eXlatEInMapRes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    MQTTSHEXPORT const TString& strXlatEInMapRes(const EInMapRes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    MQTTSHEXPORT tCIDLib::TBoolean bIsValidEnum(const EInMapRes eVal);
    ...
    MQTTSHEXPORT tCIDLib::TBoolean bIsValidEnum(const EMsgSrcs eVal);
    ...
    MQTTSHEXPORT EPLTypes eXlatEPLTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    MQTTSHEXPORT const TString& strXlatEPLTypes(const EPLTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    MQTTSHEXPORT tCIDLib::TBoolean bIsValidEnum(const EPLTypes eVal);
