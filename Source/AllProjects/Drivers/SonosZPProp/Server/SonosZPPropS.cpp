...
namespace SonosZPPropS
{
    ...
    // -----------------------------------------------------------------------
    TFacility* pfacSonosZPPropS = nullptr;
}
...
TFacility& facSonosZPPropS()
{
    ...
    //  it exists.
    //
    return *SonosZPPropS::pfacSonosZPPropS;
}
...
psdrvMakeNewSrv(const TCQCDriverObjCfg& cqcdcToLoad)
{
    ...
    (
        tCIDLib::ECSSides::Server, cqcdcToLoad, kSonosZPPropS::pszServerFacName
    );
    ...
    //  in.
    //
    SonosZPPropS::pfacSonosZPPropS = new TFacility
    (
        kSonosZPPropS::pszServerFacName
        , tCIDLib::EModTypes::SharedLib
        , kSonosZPPropS::c4MajVersion
        , kSonosZPPropS::c4MinVersion
        , kSonosZPPropS::c4Revision
        , tCIDLib::EModFlags::HasMsgFile
    );

    // And now gen up an instance of our driver and return it
    return new TSonosZPPropSDriver(cqcdcToLoad);
}
