...
// DESCRIPTION:
//
//  This is the main implementation file for the logic server driver
...
TFacility& facCQSLLogicS()
{
    ...
    //  it exists.
    //
    return *CQSLLogicS::pfacCQSLLogicS;
}
...
psdrvMakeNewSrv(const  TCQCDriverObjCfg& cqcdcToLoad)
{
    ...
    //  in.
    //
    CQSLLogicS::pfacCQSLLogicS = new TFacility
    (
        kCQSLLogicS::pszServerFacName
    ...
    return new TCQSLLogicSDriver(cqcdcToLoad);
}
