...
namespace ZoomPlayerS
{
    ...
    // -----------------------------------------------------------------------
    TFacility* pfacZoomPlayerS = nullptr;
}
...
TFacility& facZoomPlayerS()
{
    ...
    //  it exists.
    //
    return *ZoomPlayerS::pfacZoomPlayerS;
}
...
psdrvMakeNewSrv(const TCQCDriverObjCfg& cqcdcToLoad)
{
    ...
    //  in.
    //
    ZoomPlayerS::pfacZoomPlayerS = new TFacility
    (
        kZoomPlayerS::pszServerFacName
        , tCIDLib::EModTypes::SharedLib
        , kZoomPlayerS::c4MajVersion
        , kZoomPlayerS::c4MinVersion
        , kZoomPlayerS::c4Revision
        , tCIDLib::EModFlags::HasMsgFile
    );

    // And now gen up an instance of our driver and return it
    return new TZoomPlayerSDriver(cqcdcToLoad);
}
