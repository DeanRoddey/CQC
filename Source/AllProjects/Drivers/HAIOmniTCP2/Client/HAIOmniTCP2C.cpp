...
namespace HAIOmniTCP2C
{
    ...
    // -----------------------------------------------------------------------
    TGUIFacility* pfacHAIOmniTCP2C = nullptr;
}
...
TGUIFacility& facHAIOmniTCP2C()
{
    ...
    //  it exists.
    //
    return *HAIOmniTCP2C::pfacHAIOmniTCP2C;
}
                ...
                , const TCQCUserCtx&        cuctxToUse)
{
    ...
    (
        tCIDLib::ECSSides::Client, cqcdcToLoad, kHAIOmniTCP2Sh::pszClientFacName
    );
    ...
    //  in.
    //
    HAIOmniTCP2C::pfacHAIOmniTCP2C = new TGUIFacility
    (
        kHAIOmniTCP2Sh::pszClientFacName
    ...
    //  client side.
    //
    THAIOmniTCP2CWnd* pwndClient = new THAIOmniTCP2CWnd(cqcdcToLoad, cuctxToUse);
