...
namespace iTunesRepoTMS
{
    ...
    // -----------------------------------------------------------------------
    TFacility* pfaciTunesRepoTMS = nullptr;
}
...
TFacility& faciTunesRepoTMS()
{
    ...
    //  it exists.
    //
    return *iTunesRepoTMS::pfaciTunesRepoTMS;
}
...
psdrvMakeNewSrv(const TCQCDriverObjCfg& cqcdcToLoad)
{
    ...
    (
        ...
        , cqcdcToLoad
        , kiTunesRepoTMS::pszServerFacName
    );
    ...
    //  in.
    //
    iTunesRepoTMS::pfaciTunesRepoTMS = new TFacility
    (
        kiTunesRepoTMS::pszServerFacName
        , tCIDLib::EModTypes::SharedLib
        , kiTunesRepoTMS::c4MajVersion
        , kiTunesRepoTMS::c4MinVersion
        , kiTunesRepoTMS::c4Revision
        , tCIDLib::EModFlags::HasMsgFile
    );

    // And now gen up an instance of our driver and return it
    return new TiTunesRepoTMSDriver(cqcdcToLoad);
}
