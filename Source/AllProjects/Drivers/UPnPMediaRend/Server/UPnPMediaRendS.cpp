...
//  should control any compliant UPnP media renderer.
//
// CAVEATS/GOTCHAS:
//
// LOG:
...
namespace UPnPMediaRendS
{
    ...
    // -----------------------------------------------------------------------
    TFacility* pfacUPnPMediaRendS = nullptr;
}
...
TFacility& facUPnPMediaRendS()
{
    ...
    //  it exists.
    //
    return *UPnPMediaRendS::pfacUPnPMediaRendS;
}
...
psdrvMakeNewSrv(const TCQCDriverObjCfg& cqcdcToLoad)
{
    ...
    (
        tCIDLib::ECSSides::Server, cqcdcToLoad, kUPnPMediaRendS::pszServerFacName
    );
    ...
    //  in.
    //
    UPnPMediaRendS::pfacUPnPMediaRendS = new TFacility
    (
        kUPnPMediaRendS::pszServerFacName
        , tCIDLib::EModTypes::SharedLib
        , kUPnPMediaRendS::c4MajVersion
        , kUPnPMediaRendS::c4MinVersion
        , kUPnPMediaRendS::c4Revision
        , tCIDLib::EModFlags::HasMsgFile
    );

    // And now gen up an instance of our driver and return it
    return new TUPnPMediaRendSDriver(cqcdcToLoad);
}
