...
namespace MediaChMgrS
{
    ...
    // -----------------------------------------------------------------------
    TFacility* pfacMediaChMgrS = nullptr;
}
...
TFacility& facMediaChMgrS()
{
    ...
    //  it exists.
    //
    return *MediaChMgrS::pfacMediaChMgrS;
}
...
psdrvMakeNewSrv(const TCQCDriverObjCfg& cqcdcToLoad)
{
    ...
    //  in.
    //
    MediaChMgrS::pfacMediaChMgrS = new TFacility
    (
        kMediaChMgrS::pszServerFacName
        , tCIDLib::EModTypes::SharedLib
        , kMediaChMgrS::c4MajVersion
        , kMediaChMgrS::c4MinVersion
        , kMediaChMgrS::c4Revision
        , tCIDLib::EModFlags::HasMsgFile
    );

    // And now gen up an instance of our driver and return it
    return new TMediaChMgrSDriver(cqcdcToLoad);
}
