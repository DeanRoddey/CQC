...
namespace VarDriverS
{
    ...
    // -----------------------------------------------------------------------
    TFacility* pfacVarDriverS = nullptr;
}
...
TFacility& facVarDriverS()
{
    ...
    //  it exists.
    //
    return *VarDriverS::pfacVarDriverS;
}
...
psdrvMakeNewSrv(const TCQCDriverObjCfg& cqcdcToLoad)
{
    ...
    //  in.
    //
    VarDriverS::pfacVarDriverS = new TFacility
    (
        kVarDriverC::pszServerFacName
    ...
    return new TVarDriverSDriver(cqcdcToLoad);
}
