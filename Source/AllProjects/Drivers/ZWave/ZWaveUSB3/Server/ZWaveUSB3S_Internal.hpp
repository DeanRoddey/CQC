...
namespace tZWaveUSB3S
{
    ...
    [[nodiscard]]  EIOStates eXlatEIOStates(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]]  const TString& strXlatEIOStates(const EIOStates eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]]  tCIDLib::TBoolean bIsValidEnum(const EIOStates eVal);
