...
namespace tZWaveUSB3Sh
{
    ...
    [[nodiscard]] ZWUSB3SHEXPORT EAeonMSTypes eXlatEAeonMSTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT const TString& strXlatEAeonMSTypes(const EAeonMSTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const EAeonMSTypes eVal);

    inline tZWaveUSB3Sh::EAeonMSTypes operator++(tZWaveUSB3Sh::EAeonMSTypes& eVal, int)
    {
        tZWaveUSB3Sh::EAeonMSTypes eTmp = eVal;
        eVal = tZWaveUSB3Sh::EAeonMSTypes(int(eVal)+1);
        return eTmp;
    }
    ...
    [[nodiscard]] ZWUSB3SHEXPORT EBinSensorTypes eXlatEBinSensorTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT const TString& strXlatEBinSensorTypes(const EBinSensorTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    ...
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const EBinSensorTypes eVal);

    inline tZWaveUSB3Sh::EBinSensorTypes operator++(tZWaveUSB3Sh::EBinSensorTypes& eVal, int)
    {
        tZWaveUSB3Sh::EBinSensorTypes eTmp = eVal;
        eVal = tZWaveUSB3Sh::EBinSensorTypes(int(eVal)+1);
        return eTmp;
    }
    ...
    [[nodiscard]] ZWUSB3SHEXPORT EBinStates eXlatEBinStates(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT const TString& strXlatEBinStates(const EBinStates eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const EBinStates eVal);
    ...
    [[nodiscard]] ZWUSB3SHEXPORT ECClasses eXlatECClasses(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT const TString& strXlatECClasses(const ECClasses eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TInt4 i4AltNumECClasses(const ECClasses eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
        [[nodiscard]] ZWUSB3SHEXPORT ECClasses eAltNumECClasses(const tCIDLib::TInt4 i4Xlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const ECClasses eVal);

    inline tZWaveUSB3Sh::ECClasses operator++(tZWaveUSB3Sh::ECClasses& eVal, int)
    {
        tZWaveUSB3Sh::ECClasses eTmp = eVal;
        eVal = tZWaveUSB3Sh::ECClasses(int(eVal)+1);
        return eTmp;
    }

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tZWaveUSB3Sh::ECClasses eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tZWaveUSB3Sh::ECClasses& eToFill)
    {
        eToFill = tZWaveUSB3Sh::ECClasses(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] ZWUSB3SHEXPORT EDevTypes eXlatEDevTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT const TString& strXlatEDevTypes(const EDevTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TInt4 i4AltNumEDevTypes(const EDevTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
        [[nodiscard]] ZWUSB3SHEXPORT EDevTypes eAltNumEDevTypes(const tCIDLib::TInt4 i4Xlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const EDevTypes eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tZWaveUSB3Sh::EDevTypes eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tZWaveUSB3Sh::EDevTypes& eToFill)
    {
        eToFill = tZWaveUSB3Sh::EDevTypes(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const EDrvStates eVal);

    inline tZWaveUSB3Sh::EDrvStates operator++(tZWaveUSB3Sh::EDrvStates& eVal, int)
    {
        tZWaveUSB3Sh::EDrvStates eTmp = eVal;
        eVal = tZWaveUSB3Sh::EDrvStates(int(eVal)+1);
        return eTmp;
    }

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tZWaveUSB3Sh::EDrvStates eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tZWaveUSB3Sh::EDrvStates& eToFill)
    {
        eToFill = tZWaveUSB3Sh::EDrvStates(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] ZWUSB3SHEXPORT EGenMSTypes eXlatEGenMSTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT const TString& strXlatEGenMSTypes(const EGenMSTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const EGenMSTypes eVal);

    inline tZWaveUSB3Sh::EGenMSTypes operator++(tZWaveUSB3Sh::EGenMSTypes& eVal, int)
    {
        tZWaveUSB3Sh::EGenMSTypes eTmp = eVal;
        eVal = tZWaveUSB3Sh::EGenMSTypes(int(eVal)+1);
        return eTmp;
    }
    ...
    [[nodiscard]] ZWUSB3SHEXPORT EGenTypes eXlatEGenTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT const TString& strXlatEGenTypes(const EGenTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TInt4 i4AltNumEGenTypes(const EGenTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
        [[nodiscard]] ZWUSB3SHEXPORT EGenTypes eAltNumEGenTypes(const tCIDLib::TInt4 i4Xlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const EGenTypes eVal);

    inline tZWaveUSB3Sh::EGenTypes operator++(tZWaveUSB3Sh::EGenTypes& eVal, int)
    {
        tZWaveUSB3Sh::EGenTypes eTmp = eVal;
        eVal = tZWaveUSB3Sh::EGenTypes(int(eVal)+1);
        return eTmp;
    }

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tZWaveUSB3Sh::EGenTypes eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tZWaveUSB3Sh::EGenTypes& eToFill)
    {
        eToFill = tZWaveUSB3Sh::EGenTypes(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] ZWUSB3SHEXPORT ENotEvTypes eXlatENotEvTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT const TString& strXlatENotEvTypes(const ENotEvTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const ENotEvTypes eVal);
    ...
    [[nodiscard]] ZWUSB3SHEXPORT ENotIdTypes eXlatENotIdTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT const TString& strXlatENotIdTypes(const ENotIdTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const ENotIdTypes eVal);
    ...
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const EMsgPrios eVal);
    ...
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const EMsgTypes eVal);
    ...
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const ETScales eVal);
    ...
    [[nodiscard]] ZWUSB3SHEXPORT EThermoModes eXlatEThermoModes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT const TString& strXlatEThermoModes(const EThermoModes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TInt4 i4AltNumEThermoModes(const EThermoModes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
        [[nodiscard]] ZWUSB3SHEXPORT EThermoModes eAltNumEThermoModes(const tCIDLib::TInt4 i4Xlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const EThermoModes eVal);

    inline tZWaveUSB3Sh::EThermoModes operator++(tZWaveUSB3Sh::EThermoModes& eVal, int)
    {
        tZWaveUSB3Sh::EThermoModes eTmp = eVal;
        eVal = tZWaveUSB3Sh::EThermoModes(int(eVal)+1);
        return eTmp;
    }
    ...
    [[nodiscard]] ZWUSB3SHEXPORT EThermoFModes eXlatEThermoFModes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT const TString& strXlatEThermoFModes(const EThermoFModes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TInt4 i4AltNumEThermoFModes(const EThermoFModes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
        [[nodiscard]] ZWUSB3SHEXPORT EThermoFModes eAltNumEThermoFModes(const tCIDLib::TInt4 i4Xlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const EThermoFModes eVal);

    inline tZWaveUSB3Sh::EThermoFModes operator++(tZWaveUSB3Sh::EThermoFModes& eVal, int)
    {
        tZWaveUSB3Sh::EThermoFModes eTmp = eVal;
        eVal = tZWaveUSB3Sh::EThermoFModes(int(eVal)+1);
        return eTmp;
    }
    ...
    [[nodiscard]] ZWUSB3SHEXPORT EThermoFStates eXlatEThermoFStates(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT const TString& strXlatEThermoFStates(const EThermoFStates eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TInt4 i4AltNumEThermoFStates(const EThermoFStates eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
        [[nodiscard]] ZWUSB3SHEXPORT EThermoFStates eAltNumEThermoFStates(const tCIDLib::TInt4 i4Xlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const EThermoFStates eVal);
    ...
    [[nodiscard]] ZWUSB3SHEXPORT EThermoStates eXlatEThermoStates(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT const TString& strXlatEThermoStates(const EThermoStates eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TInt4 i4AltNumEThermoStates(const EThermoStates eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
        [[nodiscard]] ZWUSB3SHEXPORT EThermoStates eAltNumEThermoStates(const tCIDLib::TInt4 i4Xlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const EThermoStates eVal);
    ...
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const EUnitAcc eVal);

    [[nodiscard]] constexpr tZWaveUSB3Sh::EUnitAcc operator|(const tZWaveUSB3Sh::EUnitAcc eLHS, const tZWaveUSB3Sh::EUnitAcc eRHS)
    {    
    ...
    [[nodiscard]] ZWUSB3SHEXPORT EUnitClasses eXlatEUnitClasses(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT const TString& strXlatEUnitClasses(const EUnitClasses eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const EUnitClasses eVal);
    ...
    [[nodiscard]] ZWUSB3SHEXPORT EUnitNameSrcs eXlatEUnitNameSrcs(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT const TString& strXlatEUnitNameSrcs(const EUnitNameSrcs eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const EUnitNameSrcs eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tZWaveUSB3Sh::EUnitNameSrcs eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tZWaveUSB3Sh::EUnitNameSrcs& eToFill)
    {
        eToFill = tZWaveUSB3Sh::EUnitNameSrcs(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] ZWUSB3SHEXPORT EUnitStates eXlatEUnitStates(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT const TString& strXlatEUnitStates(const EUnitStates eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] ZWUSB3SHEXPORT const TString& strAltXlatEUnitStates(const EUnitStates eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] ZWUSB3SHEXPORT EUnitStates eAltXlatEUnitStates(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const EUnitStates eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tZWaveUSB3Sh::EUnitStates eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tZWaveUSB3Sh::EUnitStates& eToFill)
    {
        eToFill = tZWaveUSB3Sh::EUnitStates(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const EValSrcs eVal);
    ...
    [[nodiscard]] ZWUSB3SHEXPORT EZWMakes eXlatEZWMakes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT const TString& strXlatEZWMakes(const EZWMakes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TInt4 i4AltNumEZWMakes(const EZWMakes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
        [[nodiscard]] ZWUSB3SHEXPORT EZWMakes eAltNumEZWMakes(const tCIDLib::TInt4 i4Xlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] ZWUSB3SHEXPORT tCIDLib::TBoolean bIsValidEnum(const EZWMakes eVal);

    inline tZWaveUSB3Sh::EZWMakes operator++(tZWaveUSB3Sh::EZWMakes& eVal, int)
    {
        tZWaveUSB3Sh::EZWMakes eTmp = eVal;
        eVal = tZWaveUSB3Sh::EZWMakes(int(eVal)+1);
        return eTmp;
    }
