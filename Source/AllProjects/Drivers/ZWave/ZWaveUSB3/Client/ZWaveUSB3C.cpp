...
// DESCRIPTION:
//
//  This is the main implementation file for the ZWave USB3 client driver facility.
//
// CAVEATS/GOTCHAS:
//
// LOG:
...
namespace ZWaveUSB3C
{
    ...
    // -----------------------------------------------------------------------
    TGUIFacility* pfacZWaveUSB3C = nullptr;


    // -----------------------------------------------------------------------
    //  The base name of our facility
    // -----------------------------------------------------------------------
    const tCIDLib::TCh* const   pszClientFacName = L"ZWaveUSB3C";
}
...
TGUIFacility& facZWaveUSB3C()
{
    ...
    //  it exists.
    //
    return *ZWaveUSB3C::pfacZWaveUSB3C;
}
                ...
                , const TCQCUserCtx&        cuctxToUse)
{
    ...
    (
        tCIDLib::ECSSides::Client, cqcdcToLoad, ZWaveUSB3C::pszClientFacName
    );
    ...
    //  in.
    //
    ZWaveUSB3C::pfacZWaveUSB3C = new TGUIFacility
    (
        ZWaveUSB3C::pszClientFacName
    ...
    //  client side.
    //
    TZWaveUSB3CWnd* pwndClient = new TZWaveUSB3CWnd(cqcdcToLoad, cuctxToUse);
