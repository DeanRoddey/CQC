...
TBinOutStream& operator<<(TBinOutStream& strmTar, const tZWaveLevi2Sh::EGenTypes eVal)
{
    strmTar.WriteEnum(tCIDLib::TCard4(eVal));
    return strmTar;
}
TBinInStream& operator>>(TBinInStream& strmSrc, tZWaveLevi2Sh::EGenTypes& eVal)
{
    eVal = tZWaveLevi2Sh::EGenTypes(strmSrc.c4ReadEnum());
    return strmSrc;
}
...
TBinOutStream& operator<<(TBinOutStream& strmTar, const tZWaveLevi2Sh::EMultiTypes eVal)
{
    strmTar.WriteEnum(tCIDLib::TCard4(eVal));
    return strmTar;
}
TBinInStream& operator>>(TBinInStream& strmSrc, tZWaveLevi2Sh::EMultiTypes& eVal)
{
    eVal = tZWaveLevi2Sh::EMultiTypes(strmSrc.c4ReadEnum());
    return strmSrc;
}
...
TBinOutStream& operator<<(TBinOutStream& strmTar, const tZWaveLevi2Sh::EMLSensTypes eVal)
{
    strmTar.WriteEnum(tCIDLib::TCard4(eVal));
    return strmTar;
}
TBinInStream& operator>>(TBinInStream& strmSrc, tZWaveLevi2Sh::EMLSensTypes& eVal)
{
    eVal = tZWaveLevi2Sh::EMLSensTypes(strmSrc.c4ReadEnum());
    return strmSrc;
}
