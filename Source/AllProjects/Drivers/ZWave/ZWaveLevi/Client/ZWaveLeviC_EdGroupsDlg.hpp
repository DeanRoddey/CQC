//
// FILE NAME: ZWaveLeviC_EdGroupsDlg.hpp
//
// AUTHOR: Dean Roddey
//
// CREATED: 06/14/2012
...
// DESCRIPTION:
//
//  This is the header for the ZWaveLeviC_EdGroupsDlg.cpp file, which implements
...
//
//  The list isn't sorted so the list window and the original data use the same
//  indices.
//
// CAVEATS/GOTCHAS:
//
