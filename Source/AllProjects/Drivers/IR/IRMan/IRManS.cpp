...
// DESCRIPTION:
//
//  This is the main implementation file for the IRMan server side driver.
//
// CAVEATS/GOTCHAS:
//
// LOG:
...
psdrvMakeNewSrv(const TCQCDriverObjCfg& cqcdcToLoad)
{
    ...
    //
    IRManS::pfacIRManS = new TFacility
    (
        kIRManS::pszServerFacName
        , tCIDLib::EModTypes::SharedLib
        , kIRManS::c4MajVersion
        , kIRManS::c4MinVersion
        , kIRManS::c4Revision
    ...
    //
    return new TIRManSDriver(cqcdcToLoad);
}
