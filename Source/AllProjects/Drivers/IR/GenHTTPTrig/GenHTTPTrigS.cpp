...
// DESCRIPTION:
//
//  This is the main implementation file for the HTTP trigger server side driver.
//
// CAVEATS/GOTCHAS:
//
// LOG:
...
namespace GenHTTPTrigS
{
    ...
    //      it up at that time.
    // -----------------------------------------------------------------------
    TFacility* pfacGenHTTPTrigS = nullptr;
}
...
TFacility& facGenHTTPTrigS()
{
    ...
    //  it exists.
    //
    return *GenHTTPTrigS::pfacGenHTTPTrigS;
}
...
psdrvMakeNewSrv(const TCQCDriverObjCfg& cqcdcToLoad)
{
    ...
    (
        ...
        , cqcdcToLoad
        , kGenHTTPTrigS::pszServerFacName
    );
    ...
    //
    GenHTTPTrigS::pfacGenHTTPTrigS = new TFacility
    (
        kGenHTTPTrigS::pszServerFacName
        , tCIDLib::EModTypes::SharedLib
        , kGenHTTPTrigS::c4MajVersion
        , kGenHTTPTrigS::c4MinVersion
        , kGenHTTPTrigS::c4Revision
    ...
    //
    return new TGenHTTPTrigSDriver(cqcdcToLoad);
}
