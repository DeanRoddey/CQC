...
// DESCRIPTION:
//
//  This is the main implementation file for the USBUIRT server side driver.
//
// CAVEATS/GOTCHAS:
//
// LOG:
...
namespace USBUIRTS
{
    ...
    //      it up at that time.
    // -----------------------------------------------------------------------
    TFacility* pfacUSBUIRTS = nullptr;
}
...
psdrvMakeNewSrv(const TCQCDriverObjCfg& cqcdcToLoad)
{
    ...
    //
    USBUIRTS::pfacUSBUIRTS = new TFacility
    (
        kUSBUIRTS::pszServerFacName
        , tCIDLib::EModTypes::SharedLib
        , kUSBUIRTS::c4MajVersion
        , kUSBUIRTS::c4MinVersion
        , kUSBUIRTS::c4Revision
    ...
    //
    return new TUSBUIRTSDriver(cqcdcToLoad);
}
