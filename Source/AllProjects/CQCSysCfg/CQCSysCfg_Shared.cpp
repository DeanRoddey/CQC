...
tCQCSysCfg::EGlobActs operator++(tCQCSysCfg::EGlobActs& eVal, int)
{
...
TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCSysCfg::EGlobActs eVal)
{
    strmTar.WriteEnum(tCIDLib::TCard4(eVal));
    return strmTar;
}
TBinInStream& operator>>(TBinInStream& strmSrc, tCQCSysCfg::EGlobActs& eVal)
{
    eVal = tCQCSysCfg::EGlobActs(strmSrc.c4ReadEnum());
    return strmSrc;
}
...
tCQCSysCfg::ERmFuncs operator++(tCQCSysCfg::ERmFuncs& eVal, int)
{
