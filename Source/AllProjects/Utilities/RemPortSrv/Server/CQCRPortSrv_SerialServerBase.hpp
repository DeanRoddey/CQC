...
class  TRemSerialSrvServerBase : public TOrbServerBase
{
    public :
        ...
        (
            const tCIDLib::TCard4 c4Cookie
            , COP TCommPortCfg& cpcfgToFill
        ) = 0;

        virtual tCIDLib::TVoid QueryFlags
        (
            const tCIDLib::TCard4 c4Cookie
            , COP tCIDComm::EFlags& eToFill
        ) = 0;

        virtual tCIDLib::TVoid QueryLineStates
        (
            const tCIDLib::TCard4 c4Cookie
            , COP tCIDLib::TBoolean& bCTSOn
            , COP tCIDLib::TBoolean& bDSROn
            , COP tCIDLib::TBoolean& bRingOn
            , COP tCIDLib::TBoolean& bRLSOn
        ) = 0;

        virtual tCIDLib::TVoid QueryXChars
        (
            const tCIDLib::TCard4 c4Cookie
            , COP tCIDLib::TCard4& c4On
            , COP tCIDLib::TCard4& c4Off
        ) = 0;
