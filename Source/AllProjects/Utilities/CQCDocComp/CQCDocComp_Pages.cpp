//
// FILE NAME: CQCDocComp_Pages.Cpp
//
// AUTHOR: Dean Roddey
//
// CREATED: 04/03/2015
                            ...
                            , const tCIDLib::TBoolean   bOptional)
{
    ...
    if (!pxtnodeCur)
    {
        if (!bOptional)
        {
            facCQCDocComp.strmErr() << L"Could not find element '" << strName
                            ...
                            ,       THelpNode&          hnToFill)
{
    ...
    for (tCIDLib::TCard4 c4Index = 0; c4Index < c4ChildCnt; c4Index++)
    {
        ...
        if (xtnodeCur.eType() == tCIDXML::ENodeTypes::Text)
        {
            ...
            hnNew.m_eType = tCQCDocComp::EType_Text;
         ...
         else if (xtnodeCur.eType() == tCIDXML::ENodeTypes::Element)
        {
            ...
            {
                hnNew.m_eType = tCQCDocComp::EType_Bold;
            }
             else if (strQName.bCompare(L"Br"))
            {
                hnNew.m_eType = tCQCDocComp::EType_Break;
            }
             else if (strQName.bCompare(L"Code"))
            {
                hnNew.m_eType = tCQCDocComp::EType_Code;
            }
             else if (strQName.bCompare(L"DIV"))
            {
                hnNew.m_eType = tCQCDocComp::EType_DIV;
                bGetID = kCIDLib::True;
            }
             else if (strQName.bCompare(L"Image"))
            {
                hnNew.m_eType = tCQCDocComp::EType_Image;
            ...
            {
                hnNew.m_eType = tCQCDocComp::EType_Indent;
            }
             else if (strQName.bCompare(L"InlineNote"))
            {
                hnNew.m_eType = tCQCDocComp::EType_InlineNote;
            }
             else if (strQName.bCompare(L"Link"))
            {
                hnNew.m_eType = tCQCDocComp::EType_Link;
            ...
            {
                hnNew.m_eType = tCQCDocComp::EType_ListItem;
            ...
            {
                hnNew.m_eType = tCQCDocComp::EType_List;
                bGetType = kCIDLib::True;
            }
             else if (strQName.bCompare(L"Note"))
            {
                hnNew.m_eType = tCQCDocComp::EType_Note;
            }
             else if (strQName.bCompare(L"P"))
            {
                hnNew.m_eType = tCQCDocComp::EType_Paragraph;
            }
             else if (strQName.bCompare(L"SecTitle"))
            {
                hnNew.m_eType = tCQCDocComp::EType_SecTitle;
            }
             else if (strQName.bCompare(L"SubSecTitle"))
            {
                hnNew.m_eType = tCQCDocComp::EType_SubSecTitle;
            }
             else if (strQName.bCompare(L"Superscript"))
            {
                hnNew.m_eType = tCQCDocComp::EType_Superscript;
            }
             else if (strQName.bCompare(L"Table"))
            {
                hnNew.m_eType = tCQCDocComp::EType_Table;
            ...
            if (bGetID)
                hnNew.m_strID = xtnodeElem.xtattrNamed(TFacCQCDocComp::s_strId).strValue();

            if (bGetRef)
                hnNew.m_strRef = xtnodeElem.xtattrNamed(TFacCQCDocComp::s_strRef).strValue();

            if (bGetType)
                hnNew.m_strType = xtnodeElem.xtattrNamed(TFacCQCDocComp::s_strType).strValue();
...
TBasePage::bProcessTableRow(const TXMLTreeElement& xtnodeRow, THelpNode& hnToFill)
{
    ...
    for (tCIDLib::TCard4 c4Index = 0; c4Index < c4Count; c4Index++)
    {
        ...
        hnCol.m_eType = tCQCDocComp::EType_TableCol;

        // Store the column span
        hnCol.m_c4Extra = xtnodeCol.xtattrNamed(TFacCQCDocComp::s_strColSpan).c4ValueAs();
...
TBasePage::bProcessTable(const TXMLTreeElement& xtnodeTbl, THelpNode& hnToFill)
{
    ...
    for (tCIDLib::TCard4 c4Index = 0; c4Index < c4Count; c4Index++)
    {
        ...
        hnRow.m_eType = tCQCDocComp::EType_TableRow;
                        ...
                        , const TString&            strKey)
{
    ...
    for (tCIDLib::TCard4 c4Index = 0; c4Index < c4Count; c4Index++)
    {
        ...
        switch(hnCur.m_eType)
        {
            ...
            case tCQCDocComp::EType_Break :
            {
                strmTar << L"<br/>";
                break;
            }

            case tCQCDocComp::EType_Code :
            {
                strmTar << L"\n<PRE>\n";
                OutputNodes(strmTar, hnCur, strKey);
                strmTar << L"</PRE>\n";
            ...
            case tCQCDocComp::EType_ListItem :
            {
                strmTar << L"<li>";
            ...
            case tCQCDocComp::EType_Paragraph :
            {
                strmTar << L"<p>";
                OutputNodes(strmTar, hnCur, strKey);
                strmTar << L"</p>";
            ...
            case tCQCDocComp::EType_SecTitle :
            {
            ...
            case tCQCDocComp::EType_SubSecTitle :
            {
            ...
            case tCQCDocComp::EType_Superscript :
            {
            ...
            case tCQCDocComp::EType_Text :
            {
                strmTar << hnCur.m_strText;
                break;
            }

            case tCQCDocComp::EType_Table :
            {
                            ...
                            , const TString&            strKey)
{
    ...
    for (tCIDLib::TCard4 c4Index = 0; c4Index < c4Count; c4Index++)
    {
        ...
        CIDAssert(hnCol.m_eType == tCQCDocComp::EType_TableCol, L"Expected a table column");
                        ...
                        , const TString&            strKey)
{
    ...
    for (tCIDLib::TCard4 c4Index = 0; c4Index < c4Count; c4Index++)
    {
        ...
        CIDAssert(hnRow.m_eType == tCQCDocComp::EType_TableRow, L"Expected a table row");
                    ...
                    , const TTopic&             topicPar)
{
    ...
    QueryElemText(xtnodePar, TFacCQCDocComp::s_strTitle, m_strTitle);
...
const TPageInfo& TTopic::tpageTopicPage(tCIDLib::TCard4& c4At) const
{
    ...
    if (c4At == c4PgCnt)
    {
        ...
        (
            CID_FILE
            , CID_LINE
            , kDocCompErrs::errcSrc_TopicPgNotFound
            , m_strTopicPath
