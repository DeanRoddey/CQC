...
TBinOutStream& operator<<(TBinOutStream& strmTar, const TiTPlayerIntfServerBase::EPlCmds eVal)
{
    strmTar.WriteEnum(tCIDLib::TCard4(eVal));
    return strmTar;
}
TBinInStream& operator>>(TBinInStream& strmSrc, TiTPlayerIntfServerBase::EPlCmds& eVal)
{
    eVal = TiTPlayerIntfServerBase::EPlCmds(strmSrc.c4ReadEnum());
    return strmSrc;
}
...
TBinOutStream& operator<<(TBinOutStream& strmTar, const TiTPlayerIntfServerBase::EPlStates eVal)
{
    strmTar.WriteEnum(tCIDLib::TCard4(eVal));
    return strmTar;
}
TBinInStream& operator>>(TBinInStream& strmSrc, TiTPlayerIntfServerBase::EPlStates& eVal)
{
    eVal = TiTPlayerIntfServerBase::EPlStates(strmSrc.c4ReadEnum());
    return strmSrc;
}
