...
namespace tWebRIVACmp
{
    ...
    enum class EConstTypes
    {
     ...
     EConstTypes eXlatEConstTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
     const TString& strXlatEConstTypes(const EConstTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
     const TString& strAltXlatEConstTypes(const EConstTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
     EConstTypes eAltXlatEConstTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
     tCIDLib::TBoolean bIsValidEnum(const EConstTypes eVal);
    ...
    enum class EMemTypes
    {
     ...
     EMemTypes eXlatEMemTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
     const TString& strXlatEMemTypes(const EMemTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
     const TString& strAltXlatEMemTypes(const EMemTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
     EMemTypes eAltXlatEMemTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
     const TString& strAltXlat2EMemTypes(const EMemTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
     EMemTypes eAltXlat2EMemTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
     tCIDLib::TBoolean bIsValidEnum(const EMemTypes eVal);
