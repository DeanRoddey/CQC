...
TTextOutStream& operator<<(TTextOutStream& strmTar, const tCQCMQTT::EConnAckCodes eVal)
{
...
TTextOutStream& operator<<(TTextOutStream& strmTar, const tCQCMQTT::EConnFlags eVal)
{
...
TTextOutStream& operator<<(TTextOutStream& strmTar, const tCQCMQTT::EPacketTypes eVal)
{
...
TTextOutStream& operator<<(TTextOutStream& strmTar, const tCQCMQTT::EQOSLevs eVal)
{
    strmTar << emapEQOSLevs.strMapEnumVal(tCIDLib::TCard4(eVal), TEnumMap::ETextVals::Text, kCIDLib::False);
    return strmTar;
}
TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCMQTT::EQOSLevs eVal)
{
    strmTar.WriteEnum(tCIDLib::TCard4(eVal));
    return strmTar;
}
TBinInStream& operator>>(TBinInStream& strmSrc, tCQCMQTT::EQOSLevs& eVal)
{
    eVal = tCQCMQTT::EQOSLevs(strmSrc.c4ReadEnum());
    return strmSrc;
}
