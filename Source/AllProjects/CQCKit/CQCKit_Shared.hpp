...
namespace tCQCKit
{
    ...
    [[nodiscard]] CQCKITEXPORT EActCmdCtx eXlatEActCmdCtx(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEActCmdCtx(const EActCmdCtx eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EActCmdCtx eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EActCmdCtx eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EActCmdCtx& eToFill)
    {
        eToFill = tCQCKit::EActCmdCtx(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EActOps eXlatEActOps(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEActOps(const EActOps eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EActOps eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EActOps eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EActOps& eToFill)
    {
        eToFill = tCQCKit::EActOps(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT const TString& strAltXlatECmdPrepRes(const ECmdPrepRes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT ECmdPrepRes eAltXlatECmdPrepRes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const ECmdPrepRes eVal);
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const ECmdRes eVal);
    ...
    [[nodiscard]] CQCKITEXPORT ECmdPTypes eXlatECmdPTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatECmdPTypes(const ECmdPTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const ECmdPTypes eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::ECmdPTypes eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::ECmdPTypes& eToFill)
    {
        eToFill = tCQCKit::ECmdPTypes(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const ECmdValRes eVal);
    ...
    [[nodiscard]] CQCKITEXPORT ECommResults eXlatECommResults(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatECommResults(const ECommResults eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT const TString& strAltXlatECommResults(const ECommResults eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT ECommResults eAltXlatECommResults(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const ECommResults eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::ECommResults eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::ECommResults& eToFill)
    {
        eToFill = tCQCKit::ECommResults(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EDevCats eXlatEDevCats(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEDevCats(const EDevCats eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EDevCats eVal);

    inline tCQCKit::EDevCats operator++(CIOP tCQCKit::EDevCats& eVal, int)
    {
        const tCQCKit::EDevCats eTmp = eVal;
        eVal = tCQCKit::EDevCats(int(eVal)+1);
        return eTmp;
    }

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EDevCats eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EDevCats& eToFill)
    {
        eToFill = tCQCKit::EDevCats(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EDevClasses eXlatEDevClasses(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEDevClasses(const EDevClasses eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT const TString& strAltXlatEDevClasses(const EDevClasses eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT EDevClasses eAltXlatEDevClasses(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strAltXlat2EDevClasses(const EDevClasses eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT EDevClasses eAltXlat2EDevClasses(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EDevClasses eVal);

    inline tCQCKit::EDevClasses operator++(CIOP tCQCKit::EDevClasses& eVal, int)
    {
        const tCQCKit::EDevClasses eTmp = eVal;
        eVal = tCQCKit::EDevClasses(int(eVal)+1);
        return eTmp;
    }

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EDevClasses eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EDevClasses& eToFill)
    {
        eToFill = tCQCKit::EDevClasses(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EDrvCaps eXlatEDrvCaps(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEDrvCaps(const EDrvCaps eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EDrvCaps eVal);
    ...
    [[nodiscard]] CQCKITEXPORT EDrvCmdWaits eXlatEDrvCmdWaits(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEDrvCmdWaits(const EDrvCmdWaits eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EDrvCmdWaits eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EDrvCmdWaits eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EDrvCmdWaits& eToFill)
    {
        eToFill = tCQCKit::EDrvCmdWaits(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EDrvStates eXlatEDrvStates(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEDrvStates(const EDrvStates eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT const TString& strAltXlatEDrvStates(const EDrvStates eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT EDrvStates eAltXlatEDrvStates(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EDrvStates eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EDrvStates eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EDrvStates& eToFill)
    {
        eToFill = tCQCKit::EDrvStates(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EDrvTypes eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EDrvTypes eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EDrvTypes& eToFill)
    {
        eToFill = tCQCKit::EDrvTypes(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EEvProcTypes eVal);

    [[nodiscard]] constexpr tCQCKit::EEvProcTypes operator|(const tCQCKit::EEvProcTypes eLHS, const tCQCKit::EEvProcTypes eRHS)
    {    
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EEvFTypes eVal);

    inline tCQCKit::EEvFTypes operator++(CIOP tCQCKit::EEvFTypes& eVal, int)
    {
        const tCQCKit::EEvFTypes eTmp = eVal;
        eVal = tCQCKit::EEvFTypes(int(eVal)+1);
        return eTmp;
    }
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EEvTrLatches eVal);

    inline tCQCKit::EEvTrLatches operator++(CIOP tCQCKit::EEvTrLatches& eVal, int)
    {
        const tCQCKit::EEvTrLatches eTmp = eVal;
        eVal = tCQCKit::EEvTrLatches(int(eVal)+1);
        return eTmp;
    }

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EEvTrLatches eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EEvTrLatches& eToFill)
    {
        eToFill = tCQCKit::EEvTrLatches(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EEvTrLatchSts eVal);
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EEvTrTypes eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EEvTrTypes eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EEvTrTypes& eToFill)
    {
        eToFill = tCQCKit::EEvTrTypes(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EEMailTypes eXlatEEMailTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEEMailTypes(const EEMailTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EEMailTypes eVal);

    inline tCQCKit::EEMailTypes operator++(CIOP tCQCKit::EEMailTypes& eVal, int)
    {
        const tCQCKit::EEMailTypes eTmp = eVal;
        eVal = tCQCKit::EEMailTypes(int(eVal)+1);
        return eTmp;
    }

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EEMailTypes eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EEMailTypes& eToFill)
    {
        eToFill = tCQCKit::EEMailTypes(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EEvMonStates eXlatEEvMonStates(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEEvMonStates(const EEvMonStates eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EEvMonStates eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EEvMonStates eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EEvMonStates& eToFill)
    {
        eToFill = tCQCKit::EEvMonStates(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EExprTypes eXlatEExprTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEExprTypes(const EExprTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EExprTypes eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EExprTypes eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EExprTypes& eToFill)
    {
        eToFill = tCQCKit::EExprTypes(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EFldAccess eXlatEFldAccess(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEFldAccess(const EFldAccess eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT const TString& strAltXlatEFldAccess(const EFldAccess eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT EFldAccess eAltXlatEFldAccess(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EFldAccess eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EFldAccess eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EFldAccess& eToFill)
    {
        eToFill = tCQCKit::EFldAccess(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EFldSTypes eXlatEFldSTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEFldSTypes(const EFldSTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT const TString& strAltXlatEFldSTypes(const EFldSTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT EFldSTypes eAltXlatEFldSTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EFldSTypes eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EFldSTypes eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EFldSTypes& eToFill)
    {
        eToFill = tCQCKit::EFldSTypes(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EFldTypes eXlatEFldTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEFldTypes(const EFldTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT const TString& strAltXlatEFldTypes(const EFldTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT EFldTypes eAltXlatEFldTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EFldTypes eVal);

    inline tCQCKit::EFldTypes operator++(CIOP tCQCKit::EFldTypes& eVal, int)
    {
        const tCQCKit::EFldTypes eTmp = eVal;
        eVal = tCQCKit::EFldTypes(int(eVal)+1);
        return eTmp;
    }

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EFldTypes eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EFldTypes& eToFill)
    {
        eToFill = tCQCKit::EFldTypes(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EIVFrmOps eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EIVFrmOps eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EIVFrmOps& eToFill)
    {
        eToFill = tCQCKit::EIVFrmOps(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT ELogOps eXlatELogOps(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatELogOps(const ELogOps eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT const TString& strAltXlatELogOps(const ELogOps eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT ELogOps eAltXlatELogOps(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const ELogOps eVal);

    inline tCQCKit::ELogOps operator++(CIOP tCQCKit::ELogOps& eVal, int)
    {
        const tCQCKit::ELogOps eTmp = eVal;
        eVal = tCQCKit::ELogOps(int(eVal)+1);
        return eTmp;
    }

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::ELogOps eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::ELogOps& eToFill)
    {
        eToFill = tCQCKit::ELogOps(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT ELoginRes eXlatELoginRes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatELoginRes(const ELoginRes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const ELoginRes eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::ELoginRes eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::ELoginRes& eToFill)
    {
        eToFill = tCQCKit::ELoginRes(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EIVMiscOps eXlatEIVMiscOps(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEIVMiscOps(const EIVMiscOps eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT const TString& strAltXlatEIVMiscOps(const EIVMiscOps eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT EIVMiscOps eAltXlatEIVMiscOps(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EIVMiscOps eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EIVMiscOps eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EIVMiscOps& eToFill)
    {
        eToFill = tCQCKit::EIVMiscOps(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EPackTypes eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EPackTypes eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EPackTypes& eToFill)
    {
        eToFill = tCQCKit::EPackTypes(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EPackFlTypes eXlatEPackFlTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEPackFlTypes(const EPackFlTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EPackFlTypes eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EPackFlTypes eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EPackFlTypes& eToFill)
    {
        eToFill = tCQCKit::EPackFlTypes(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EPowerStatus eXlatEPowerStatus(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEPowerStatus(const EPowerStatus eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EPowerStatus eVal);

    inline tCQCKit::EPowerStatus operator++(CIOP tCQCKit::EPowerStatus& eVal, int)
    {
        const tCQCKit::EPowerStatus eTmp = eVal;
        eVal = tCQCKit::EPowerStatus(int(eVal)+1);
        return eTmp;
    }

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EPowerStatus eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EPowerStatus& eToFill)
    {
        eToFill = tCQCKit::EPowerStatus(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EPromptTypes eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EPromptTypes eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EPromptTypes& eToFill)
    {
        eToFill = tCQCKit::EPromptTypes(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EReplyStyles eXlatEReplyStyles(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEReplyStyles(const EReplyStyles eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT const TString& strAltXlatEReplyStyles(const EReplyStyles eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT EReplyStyles eAltXlatEReplyStyles(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EReplyStyles eVal);

    inline tCQCKit::EReplyStyles operator++(CIOP tCQCKit::EReplyStyles& eVal, int)
    {
        const tCQCKit::EReplyStyles eTmp = eVal;
        eVal = tCQCKit::EReplyStyles(int(eVal)+1);
        return eTmp;
    }

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EReplyStyles eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EReplyStyles& eToFill)
    {
        eToFill = tCQCKit::EReplyStyles(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EReqAccess eXlatEReqAccess(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEReqAccess(const EReqAccess eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    CQCKITEXPORT const TString& strLoadEReqAccess(const EReqAccess eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strAltXlatEReqAccess(const EReqAccess eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT EReqAccess eAltXlatEReqAccess(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EReqAccess eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EReqAccess eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EReqAccess& eToFill)
    {
        eToFill = tCQCKit::EReqAccess(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    [[nodiscard]] constexpr tCQCKit::EReqAccess operator|(const tCQCKit::EReqAccess eLHS, const tCQCKit::EReqAccess eRHS)
    {    
    ...
    [[nodiscard]] CQCKITEXPORT ESchTypes eXlatESchTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatESchTypes(const ESchTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    CQCKITEXPORT const TString& strLoadESchTypes(const ESchTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const ESchTypes eVal);

    inline tCQCKit::ESchTypes operator++(CIOP tCQCKit::ESchTypes& eVal, int)
    {
        const tCQCKit::ESchTypes eTmp = eVal;
        eVal = tCQCKit::ESchTypes(int(eVal)+1);
        return eTmp;
    }

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::ESchTypes eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::ESchTypes& eToFill)
    {
        eToFill = tCQCKit::ESchTypes(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EScrNavOps eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EScrNavOps eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EScrNavOps& eToFill)
    {
        eToFill = tCQCKit::EScrNavOps(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EStatements eXlatEStatements(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEStatements(const EStatements eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EStatements eVal);

    inline tCQCKit::EStatements operator++(CIOP tCQCKit::EStatements& eVal, int)
    {
        const tCQCKit::EStatements eTmp = eVal;
        eVal = tCQCKit::EStatements(int(eVal)+1);
        return eTmp;
    }

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EStatements eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EStatements& eToFill)
    {
        eToFill = tCQCKit::EStatements(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EStmtRes eVal);
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EStdACOps eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EStdACOps eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EStdACOps& eToFill)
    {
        eToFill = tCQCKit::EStdACOps(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EStdDrvEvs eXlatEStdDrvEvs(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEStdDrvEvs(const EStdDrvEvs eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    CQCKITEXPORT const TString& strLoadEStdDrvEvs(const EStdDrvEvs eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EStdDrvEvs eVal);

    inline tCQCKit::EStdDrvEvs operator++(CIOP tCQCKit::EStdDrvEvs& eVal, int)
    {
        const tCQCKit::EStdDrvEvs eTmp = eVal;
        eVal = tCQCKit::EStdDrvEvs(int(eVal)+1);
        return eTmp;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EStdFields eXlatEStdFields(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEStdFields(const EStdFields eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT const TString& strAltXlatEStdFields(const EStdFields eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT EStdFields eAltXlatEStdFields(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EStdFields eVal);

    inline tCQCKit::EStdFields operator++(CIOP tCQCKit::EStdFields& eVal, int)
    {
        const tCQCKit::EStdFields eTmp = eVal;
        eVal = tCQCKit::EStdFields(int(eVal)+1);
        return eTmp;
    }

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EStdFields eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EStdFields& eToFill)
    {
        eToFill = tCQCKit::EStdFields(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT ETEvFilters eXlatETEvFilters(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatETEvFilters(const ETEvFilters eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const ETEvFilters eVal);

    inline tCQCKit::ETEvFilters operator++(CIOP tCQCKit::ETEvFilters& eVal, int)
    {
        const tCQCKit::ETEvFilters eTmp = eVal;
        eVal = tCQCKit::ETEvFilters(int(eVal)+1);
        return eTmp;
    }

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::ETEvFilters eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::ETEvFilters& eToFill)
    {
        eToFill = tCQCKit::ETEvFilters(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT ETEvFiltLOps eXlatETEvFiltLOps(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatETEvFiltLOps(const ETEvFiltLOps eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const ETEvFiltLOps eVal);

    inline tCQCKit::ETEvFiltLOps operator++(CIOP tCQCKit::ETEvFiltLOps& eVal, int)
    {
        const tCQCKit::ETEvFiltLOps eTmp = eVal;
        eVal = tCQCKit::ETEvFiltLOps(int(eVal)+1);
        return eTmp;
    }

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::ETEvFiltLOps eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::ETEvFiltLOps& eToFill)
    {
        eToFill = tCQCKit::ETEvFiltLOps(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EEvSrvTypes eXlatEEvSrvTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEEvSrvTypes(const EEvSrvTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT const TString& strAltXlatEEvSrvTypes(const EEvSrvTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT EEvSrvTypes eAltXlatEEvSrvTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EEvSrvTypes eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EEvSrvTypes eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EEvSrvTypes& eToFill)
    {
        eToFill = tCQCKit::EEvSrvTypes(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EUserTypes eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EUserTypes eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EUserTypes& eToFill)
    {
        eToFill = tCQCKit::EUserTypes(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EUserRoles eXlatEUserRoles(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEUserRoles(const EUserRoles eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    CQCKITEXPORT const TString& strLoadEUserRoles(const EUserRoles eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strAltXlatEUserRoles(const EUserRoles eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT EUserRoles eAltXlatEUserRoles(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EUserRoles eVal);

    inline tCQCKit::EUserRoles operator++(CIOP tCQCKit::EUserRoles& eVal, int)
    {
        const tCQCKit::EUserRoles eTmp = eVal;
        eVal = tCQCKit::EUserRoles(int(eVal)+1);
        return eTmp;
    }

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EUserRoles eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EUserRoles& eToFill)
    {
        eToFill = tCQCKit::EUserRoles(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EValResults eVal);
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EValQRes eVal);
    ...
    [[nodiscard]] CQCKITEXPORT EVerboseLvls eXlatEVerboseLvls(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEVerboseLvls(const EVerboseLvls eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EVerboseLvls eVal);

    inline tCQCKit::EVerboseLvls operator++(CIOP tCQCKit::EVerboseLvls& eVal, int)
    {
        const tCQCKit::EVerboseLvls eTmp = eVal;
        eVal = tCQCKit::EVerboseLvls(int(eVal)+1);
        return eTmp;
    }

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCKit::EVerboseLvls eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCKit::EVerboseLvls& eToFill)
    {
        eToFill = tCQCKit::EVerboseLvls(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCKITEXPORT EZoneStates eXlatEZoneStates(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCKITEXPORT const TString& strXlatEZoneStates(const EZoneStates eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT const TString& strAltXlatEZoneStates(const EZoneStates eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCKITEXPORT EZoneStates eAltXlatEZoneStates(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    ...
    [[nodiscard]] CQCKITEXPORT tCIDLib::TBoolean bIsValidEnum(const EZoneStates eVal);

    inline tCQCKit::EZoneStates operator++(CIOP tCQCKit::EZoneStates& eVal, int)
    {
        const tCQCKit::EZoneStates eTmp = eVal;
        eVal = tCQCKit::EZoneStates(int(eVal)+1);
        return eTmp;
    }
