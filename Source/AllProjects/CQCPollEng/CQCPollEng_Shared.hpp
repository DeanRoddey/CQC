...
namespace tCQCPollEng
{
    ...
    CQCPOLLENGEXPORT tCIDLib::TBoolean bIsValidEnum(const EFldActs eVal);
    ...
    CQCPOLLENGEXPORT EFldRegRes eXlatEFldRegRes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    CQCPOLLENGEXPORT const TString& strXlatEFldRegRes(const EFldRegRes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    ...
    CQCPOLLENGEXPORT tCIDLib::TBoolean bIsValidEnum(const EFldRegRes eVal);
    ...
    CQCPOLLENGEXPORT tCIDLib::TBoolean bIsValidEnum(const EFldStates eVal);
