//
// FILE NAME: CQCDrvDev_QDrvTextDlg.hpp
//
// AUTHOR: Dean Roddey
//
// CREATED: 09/25/2012
...
// DESCRIPTION:
//
//  This is the header for the file file CQCDrvDev_QDrvTextDlg.cpp file,
...
// PREFIX: wnd
// ---------------------------------------------------------------------------
class TCQCQDrvTextDlg : public TDlgBox
{
    public  :
        // -------------------------------------------------------------------
    ...
    private :
        ...
        //  Magic macros
        // -------------------------------------------------------------------
        RTTIDefs(TCQCQDrvTextDlg,TDlgBox)
};
