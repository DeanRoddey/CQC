...
//  DATE: Sun, Mar 28 14:41:33 2021 -0400
//
...
namespace kCQCRemBrws
{
    ...
    CQCREMBRWSEXP const extern TString strPath_Help_Development;
    CQCREMBRWSEXP const extern TString strPath_Help_Development_Overview;
    CQCREMBRWSEXP const extern TString strPath_Development;
    ...
    CQCREMBRWSEXP const extern TString strItem_Development;
    CQCREMBRWSEXP const extern TString strItem_Overview;
...
namespace tCQCRemBrws
{
    ...
    [[nodiscard]] CQCREMBRWSEXP EDTypes eXlatEDTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCREMBRWSEXP const TString& strXlatEDTypes(const EDTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    CQCREMBRWSEXP const TString& strLoadEDTypes(const EDTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCREMBRWSEXP const TString& strAltXlatEDTypes(const EDTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCREMBRWSEXP EDTypes eAltXlatEDTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCREMBRWSEXP const TString& strAltXlat2EDTypes(const EDTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]] CQCREMBRWSEXP EDTypes eAltXlat2EDTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCREMBRWSEXP tCIDLib::TBoolean bIsValidEnum(const EDTypes eVal);

    inline tCQCRemBrws::EDTypes operator++(tCQCRemBrws::EDTypes& eVal, int)
    {
        tCQCRemBrws::EDTypes eTmp = eVal;
        eVal = tCQCRemBrws::EDTypes(int(eVal)+1);
        return eTmp;
    }

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCRemBrws::EDTypes eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCRemBrws::EDTypes& eToFill)
    {
        eToFill = tCQCRemBrws::EDTypes(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    ...
    [[nodiscard]] CQCREMBRWSEXP EItemFlags eXlatEItemFlags(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCREMBRWSEXP const TString& strXlatEItemFlags(const EItemFlags eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    CQCREMBRWSEXP const TString& strLoadEItemFlags(const EItemFlags eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]] CQCREMBRWSEXP tCIDLib::TBoolean bIsValidEnum(const EItemFlags eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCRemBrws::EItemFlags eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCRemBrws::EItemFlags& eToFill)
    {
        eToFill = tCQCRemBrws::EItemFlags(strmSrc.c4ReadEnum());
        return strmSrc;
    }
    [[nodiscard]] constexpr tCQCRemBrws::EItemFlags operator|(const tCQCRemBrws::EItemFlags eLHS, const tCQCRemBrws::EItemFlags eRHS)
    {    
    ...
    [[nodiscard]] CQCREMBRWSEXP tCIDLib::TBoolean bIsValidEnum(const EQSFlags eVal);

    inline TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCRemBrws::EQSFlags eVal)
    {
        strmTar.WriteEnum(tCIDLib::TCard4(eVal));
        return strmTar;
    }
    inline TBinInStream& operator>>(TBinInStream& strmSrc, COP tCQCRemBrws::EQSFlags& eToFill)
    {
        eToFill = tCQCRemBrws::EQSFlags(strmSrc.c4ReadEnum());
        return strmSrc;
    }
}
