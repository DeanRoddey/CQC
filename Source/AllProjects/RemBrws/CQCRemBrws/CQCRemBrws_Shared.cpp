...
tCQCRemBrws::EDTypes operator++(tCQCRemBrws::EDTypes& eVal, int)
{
...
TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCRemBrws::EDTypes eVal)
{
    strmTar.WriteEnum(tCIDLib::TCard4(eVal));
    return strmTar;
}
TBinInStream& operator>>(TBinInStream& strmSrc, tCQCRemBrws::EDTypes& eVal)
{
    eVal = tCQCRemBrws::EDTypes(strmSrc.c4ReadEnum());
    return strmSrc;
}
...
TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCRemBrws::EItemFlags eVal)
{
    strmTar.WriteEnum(tCIDLib::TCard4(eVal));
    return strmTar;
}
TBinInStream& operator>>(TBinInStream& strmSrc, tCQCRemBrws::EItemFlags& eVal)
{
    eVal = tCQCRemBrws::EItemFlags(strmSrc.c4ReadEnum());
    return strmSrc;
}
...
TBinOutStream& operator<<(TBinOutStream& strmTar, const tCQCRemBrws::EQSFlags eVal)
{
    strmTar.WriteEnum(tCIDLib::TCard4(eVal));
    return strmTar;
}
TBinInStream& operator>>(TBinInStream& strmSrc, tCQCRemBrws::EQSFlags& eVal)
{
    eVal = tCQCRemBrws::EQSFlags(strmSrc.c4ReadEnum());
    return strmSrc;
}
